...
public class CustomToolbar extends Toolbar {
    ...
    //设置title右边文字颜色
    public void setMainTitleRightTextSize(int size) {
        mTvMainTitleRight.setTextSize(size);
    }
    //设置title右边图标
    ...
    //设置titles上边图标
    public void setMainTitleRightForTopDrawable(int res) {
        Drawable dwRight = ContextCompat.getDrawable(getContext(), res);
        dwRight.setBounds(0, 0, dwRight.getMinimumWidth(), dwRight.getMinimumHeight());
        mTvMainTitleRight.setCompoundDrawables(null, dwRight, null, null);
    }
